...
# named Resources.cmake, for the reason HFTargetSetup.cmake gives: this
# project's CMAKE_MODULE_PATH entry is appended before eacp's, so a module here
# that shares a name with one of eacp's shadows it.
#
#   hf_copy_resources(<target> FILES <file>... [DESTINATION <subdirectory>])
#
...
# rebuild that changed nothing from rewriting 5 GB. It is a copy of the bytes,
...
#
# The runtime half is HF::resourcesDirectory(), which resolves the same two
# destinations from inside the running binary.
function(hf_copy_resources target)
    cmake_parse_arguments(ARG "" "DESTINATION" "FILES" ${ARGN})

    if (NOT ARG_FILES)
        message(FATAL_ERROR "hf_copy_resources(${target}) was given no FILES")
    endif ()
