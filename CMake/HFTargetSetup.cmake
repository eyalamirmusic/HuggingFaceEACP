...
# it.
#
# The functions carry an `hf_` prefix for the same class of reason: CMake
...
# is not something a call site can see. Check `eacp/CMake/` before adding a
# module here. `FindNanoTest.cmake` is the one name this project shares with it
# on purpose, both files being the same three-line fetch of the same tag.

function(hf_set_default_warnings_level target)
    if (MSVC)
...
function(hf_set_default_target_setting target)
    hf_set_default_warnings_level(${target})
...
function(hf_enable_unity_build target)
    if (HF_EACP_UNITY_BUILD)
...
function(hf_add_ide_sources target)
