...
// read what was stored — so an expression built on the read and used after the
// store would be recomputed from the stored value: exp of the exp.
//
...
{
    explicit Softmax(int laneCount = groupWidth)
